...
('SPORTS', '서울 스키장', '경기도 성남시 대왕판교로 999', '010-9999-0000', 30, 20, '판교는 정말 체크남방셔츠 뿐인가'),
('RESTAURANT', '우마이돈', '서울시 강남구 가나대로 123', '010-1234-5678', 29, 10, '테스트 메모'),
('SPORTS', '서울 배드민턴', '하늘 천국 천국로 555', '010-1004-1004', 15, 9000, null),
('COMMON', 'ktds 본사', '111, Gana-ro, Gangnam-gu, Seoul', '010-1111-1111', 5, 50, '패캠마니사랑해주세열'),
